...
public class BoardTest extends TestCase {
	...
	public void testPrint() throws Exception {
		board.initialize();
		String expected = RankTest.BLACK_EXCEPT_PAWN_RANK
				+ GeneratingBoard.NEW_LINE 
				+ RankTest.BLACK_PAWN_RANK
				+ GeneratingBoard.NEW_LINE 
				+ createEmptyRank() + createEmptyRank() 
				+ createEmptyRank() + createEmptyRank()
				+ RankTest.WHITE_PAWN_RANK 
				+ GeneratingBoard.NEW_LINE
				+ RankTest.WHITE_EXCEPT_PAWN_RANK 
				+ GeneratingBoard.NEW_LINE;
	...
	public void testInitializeEmpty() throws Exception {
		board.setInitialize(new InitializingBoardEmpty());
		board.initialize();
		System.out.println(board.generateBoard());
	}
	...
	public void testPrintUsingInterface() throws Exception {
		board.initialize();
		String expected = RankTest.BLACK_EXCEPT_PAWN_RANK
				+ GeneratingBoard.NEW_LINE + RankTest.BLACK_PAWN_RANK
				+ GeneratingBoard.NEW_LINE + createEmptyRank()
		...
		assertEquals("이 메세지가 보인다면 웹 페이지용으로 출력이 가능한 상태입니다.",
				board.generateBoard());
		System.out.println(board.generateBoard());
	}
}
